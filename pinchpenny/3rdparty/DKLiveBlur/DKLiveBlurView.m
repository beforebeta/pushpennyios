...
//    NSLog(@"BLUR NUMERATOR %.2f",(self.scrollView.contentOffset.y + self.scrollView.contentInset.top));
//    NSLog(@"BLUR DEMONINATOR %.2f",(2 * CGRectGetHeight(self.bounds) / 7));
//    NSLog(@"BLUR RESULT %.2f",(self.scrollView.contentOffset.y + self.scrollView.contentInset.top) / (2 * CGRectGetHeight(self.bounds) / 7));
    [self setBlurLevel:(self.scrollView.contentOffset.y + self.scrollView.contentInset.top) / (2 * CGRectGetHeight(self.bounds) / 7)];
}
